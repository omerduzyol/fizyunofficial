...
#define SHKMyAppName			@"Fizy Mobile"
#define SHKMyAppURL				@"http://fizy.com"
...
#define SHKFacebookKey				@"234505096585561"
#define SHKFacebookSecret			@"f9f8ed123d6c568538b1fb72119a1ee2"
 ...
 */
#define SHKTwitterConsumerKey		@"aFhqrBMfV4rOa6r99Vf8YA"
#define SHKTwitterSecret			@"wrrzzeiR1yR037GP6EQ7p1LQbsJCZq8qt0nj7jcHQz4"
#define SHKTwitterCallbackUrl		@"http://fizyios.creaworks.net/twitterAuth.htm" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"fizyios"
#define SHKBitLyKey					@"R_649074de66225a54e1736be177864859"
